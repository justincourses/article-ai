...
1. 按照上述结构生成一篇完整的文章
2. 严格保持文章结构的层次性和逻辑性
3. 使用规范的 Markdown 格式，包括标题层级、列表和引用
...
需要注意的是，结构只是写作内容的参考，但不是文章结构的硬性要求，行文方式和文章结构应该考虑到文章风格及受众，以及其他的特别要求来调整。
